export function createWebRTCTransport(config, deps) {
    ...
    return {
        ...
        send(event) {
            if (dataChannel && dataChannel.readyState === "open") {
                ...
                console.log("📤 Sent message:", event.type);
            }
            else {
                console.warn("⚠️ DataChannel not open, cannot send message:", event.type);
            }
        },
        async close() {
