...
export const errorRateAlertRules = [
    {
...
export const circuitBreakerAlertRules = [
    {
...
export const quotaAlertRules = [
    {
        ...
        condition: (data) => {
            return data.percentUsed > 80 && data.percentUsed <= 90;
        },
...
export const costAlertRules = [
    {
        ...
        condition: (data) => {
            ...
            return (data.dailyCost > dailyThreshold * 0.8 &&
                data.dailyCost <= dailyThreshold);
        },
    ...
    },
    {
        ...
        condition: (data) => {
            const dailyThreshold = 5.0;
            return data.dailyCost > dailyThreshold;
        },
        throttleMs: 30 * 60 * 1000, // 30 minutes
        enabled: true,
    },
    {
        ...
        condition: (data) => {
            ...
            return data.monthlyCost > monthlyThreshold;
        },
...
export const sessionDurationAlertRules = [
    {
        ...
        condition: (data) => {
            ...
            const avgDuration = data.averageDuration || 300000; // 5 minutes default
            return (data.duration > avgDuration * 2 ||
                data.duration < avgDuration * 0.1);
        },
        throttleMs: 15 * 60 * 1000, // 15 minutes
        enabled: true,
    },
...
export const apiAvailabilityAlertRules = [
    {
...
export const toolExecutionAlertRules = [
    {
...
export const memoryAlertRules = [
    {
        ...
        condition: (data) => {
            return (data.memoryUsagePercent > 80 &&
                data.memoryUsagePercent <= 90);
        },
        throttleMs: 10 * 60 * 1000, // 10 minutes
        enabled: true,
    },
    {
        ...
        source: "system_monitor",
        condition: (data) => {
            return data.memoryUsagePercent > 90;
        },
        throttleMs: 5 * 60 * 1000, // 5 minutes
        enabled: true,
    },
...
export function registerAllAlertRules(alertManager) {
