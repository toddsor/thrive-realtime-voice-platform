...
export async function echoTool(args, user) {
...
export function isToolAllowed(toolName, allowedTools, toolPolicy) {
...
// Execute a tool call
export async function executeToolCall(toolCall, allowedTools, toolPolicy, logger) {
