        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {sessionStatus.gracePeriodActive && (
              <div className="text-sm text-red-600">🚨 Grace period active - session will end soon</div>
            )}
      ...
      {quotaStatus && (
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {!quotaStatus.allowed && (
              <div className="text-sm text-red-600">❌ Quota exceeded - cannot start new sessions</div>
            )}
